...
//*****************************************************************************
	...
	ofile<<"<!-- This webpage is craeted by Tomas Truhlar -->"<<endl;
	ofile<<"<html>"<<endl;
	ofile<<"<!-- Head truhlar --><!-- **************************************** -->"<<endl;
	ofile<<"<head>"<<endl;
	...
	ofile<<"<img src=\"./analysis/"<<RunNumber<<"/"<<RunNumber<<"_east_sum.gif\" alt=\""<<RunNumber<<"_east_sum.gif\" width=\"360\" height \"240\"/></A>"<<endl;ofile<<"<br />"<<endl;
