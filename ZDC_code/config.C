...
//	emailNotification = "cjena@rcf.rhic.bnl.gov";
...
// THIS NEEDS TO BE CHANGED EVERY RUN (not run number)
 	...
 	dirOut = "/gpfs01/star/pwg/truhlar/ZDC/ZDC_Calibration/run22.ZdcCalibration.truhlar";
	seenRuns = "/gpfs01/star/pwg/truhlar/ZDC/ZDC_code/seenRuns/seenRuns_run22.truhlar.txt";
...
//	publicDir = "http://www.star.bnl.gov/protected/lfspectra/cjena/run10/zdcMonitoring/ZDC_onlinePlots/";
//	publicDir = "http://www.star.bnl.gov/protected/lfspectra/yhzhu/zdc2011/";
	publicDir = "";
...
// THIS NEEDS TO BE CHANGED EVERY RUN
		filename = "/gpfs01/star/pwg/truhlar/ZDC/ZDC_code/data/run22.ZdcCalibration.truhlar.list";
	...
	Int_t ZDCMB = (1 << 9);
	Int_t ZDCpol = (1 << 9);
	//tcuBitsToProcess = Form("%i %i", ZDCMB, ZDCpol);
	//tcuBitsToProcess = Form("%i", 
	
	/* tcuBitsToProcess = Form("%i %i %i %i %i %i %i %i %i %i", 
	BBCE|ZDCEF|ZDCEB, 
	BBCE|ZDCWF|ZDCWB, 
	BBCW|ZDCEF|ZDCEB, 
	BBCW|ZDCWF|ZDCWB, 
...
//		seenRuns = "./seenRuns.txt";// move to the beginning by Yifei Xu
...
//	filename = "/star/u/cjena/lbl/run10/zdcMonitoring/final/trg/trgdata/*.dat";
